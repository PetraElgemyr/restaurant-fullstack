      ...
      <ContactInfoContainer>
        <WrapperColumn>
          ...
          <GdprSpan>
            ...
            information om individen har gett sitt samtycke. Då
            personinformation är nödvändig för att veta vem som skall ha en
            bokning så sparas förnamn, efternamn, mejladressen och telefonnummer
            när man gör en bokning. Personuppgifterna kommer kvarstå i 3 månader
            efter att bokningen ägt rum. Detta med syfte för att kunna hantera
            eventuella förändringar, avbokningar och klagomål. Godkännandet
            måste ges en gång per bokning. Vid eventuella frågor, kontakta oss
            via mejl eller per telefon.
          </GdprSpan>
        </WrapperColumn>{" "}
      </ContactInfoContainer>
    </ContactContainer>
